...
import { command, on, hook } from '../../src/common/property'
import { enter, leave } from '../../src/helpers'
import { bindedHooks } from '../../src/hooks'
...
class BotModule extends Launch {
    ...
    start = 'Hello #{fullName}! Try /go' // string template. #{fullName} replaced with hook fullName result
